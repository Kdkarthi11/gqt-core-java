 ...
 * @author karthi v
 * @category Patterns
 * @description This is an example for conditional pattern - alphabet Name KARTHI V
 */
public class ConditionalPattern_Alphabet_KARTHI {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < n; i++) {
			...
			System.out.print(" 	 ");
			for(int j=0;j<n;j++) {
				if(j==0 && i<(n/2)|| i-j ==(n/2) || j+i ==(n-1)+(n/2) 
						||j==(n-1) && i<(n/2)) 
				{
					System.out.print("# ");
				}
